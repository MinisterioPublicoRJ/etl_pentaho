...
def carga_painel_comprasrj():
    ...
    # origem - SIGA
    result_df_item_contrato = dbcommons.load_table(configs=configs, jndi_name=configs.settings.JDBC_PROPERTIES[
        configs.settings.DB_OPENGEO_DS_NAME].jndi_name, schema_name='comprasrj_stage', table_name='itens_contratos')[
        'table']
    ...
    result_df_contrato['DT_FIM'] = safe_column_string_to_datetime(dataframe=result_df_contrato, column_name='DT_FIM')
    ...
    result_df_compra = dbcommons.load_table(configs=configs, jndi_name=configs.settings.JDBC_PROPERTIES[
        configs.settings.DB_OPENGEO_DS_NAME].jndi_name, schema_name='comprasrj_stage', table_name='compras_diretas')[
        'table']
    ...
    result_df_compra['VL_PROCESSO'] = safe_column_string_to_float(dataframe=result_df_compra, column_name='VL_PROCESSO')
    result_df_compra['VL_UNITARIO'] = safe_column_string_to_float(dataframe=result_df_compra, column_name='VL_UNITARIO')
